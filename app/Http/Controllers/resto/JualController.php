...
public function postproses($id)
{
        ...
        $jual->save(); }, 5); }catch(\Exception $e){ return redirect('/resto/home') ->withErrors(['msg' => $e->getMessage()]);
        }
...
public function postcancel($id)
{
        ...
        $jual->save();
        }catch(\Exception $e){ return redirect('/resto/home') ->withErrors(['msg' => $e->getMessage()]);
        }
