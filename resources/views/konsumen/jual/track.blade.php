...
Carbon\Carbon::parse($jual->waktu_tiba)->format('d-M-Y H:i:s').' ('.Carbon\Carbon::parse($jual->waktu_tiba)
 ...
 Carbon\Carbon::parse($jual->waktu_batal)->diffForHumans(Carbon\Carbon::parse($jual->waktu_pesan)).')' : '' }}</td></tr>
 </tbody>
</table>
